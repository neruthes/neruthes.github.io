...
xmlns:slash="http://purl.org/rss/1.0/modules/slash/">\n\
    <channel>\n\
        ...
        <atom:link href="https://neruthes.github.io/blog/feed.rss" rel="self" type="application/rss+xml" />\n\
        <link>https://neruthes.github.io/blog/</link>\n\
	    ...
	    <generator>https://neruthes.github.io/blog/</generator>\n\
__ITEMS__\n\
    </channel>\n\
</rss>';
...
for (var i = maxId; i >= 0; i--) {
	if (listJson[i].D !== 0) {
    	...
    	.replace(/__URL__/g, 'https://neruthes.github.io/blog/?p=' + i)
